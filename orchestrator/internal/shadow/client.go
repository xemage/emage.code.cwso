...
//
// POC-DEBT: One TCP-style request-per-connection model. Production should
// pool connections and pipeline requests; tracked under T029.
package shadow
...
// Client is a goroutine-safe client to a single sidecar socket.
type Client struct {
	socket string
	mu     sync.Mutex
}
