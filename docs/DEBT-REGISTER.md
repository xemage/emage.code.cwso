...
**Result: 26/26 rows classified. Zero unclassified rows.** (`fixed`: 11 — B2, B6, B7,
B12, B13, D3, D6, P2-3, R-3, R-7, R-9; `documented-limitation`: 3 — B1, R-1, R-6;
`v1.1`: 12 — B11, D2, D4, D5, D8, P2-2, P2-8, R-2, R-4, R-5, R-8, R-10.)
