...
Release packaging: **T139** → `v0.3.0-rc1` tagged on `develop` (`2032b33`). **T135** KV prefix router landed (!49 → `0685893`). **T140** CI audit hardening complete (!50 → `130a254`) — `go:audit` / `rust:audit` now blocking before GA.
